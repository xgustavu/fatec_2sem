...
select t.codigo_titulo, s.status
from tbl_titulo t
left join tbl_livros s on t.codigo_titulo = s.codigo_titulo;
...
select c.Nome, e.codigo_cliente
from tbl_cliente c
...
--6 Retorne o nome, titulo do livro e o status do esmprestimo do livro alugado pela Ana Oliveira (retorna 1 linha)3
